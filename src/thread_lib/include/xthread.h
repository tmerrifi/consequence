...
public:
    ...
    static void * spawn(threadFunction * fn, void * arg, int parent_index, ThreadPoolEntry * tpe);
...
private:
    ...
    static void * forkSpawn(threadFunction * fn, void * arg, int threadindex, ThreadPoolEntry * tpe);
    
    static void do_work(int parent_index, ThreadPoolEntry * tpe);
